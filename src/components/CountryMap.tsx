          ...
          <HybridMap
            ...
            tooltip={(d: HybridMapDataPoint) => (
              <div style={{ textAlign: "center", padding: "4px" }}>
                ...
                <p style={{ fontSize: "14px", fontWeight: 500, color: "#009edb", margin: "8px 0 0 0", display: "flex", alignItems: "center", justifyContent: "center", gap: "4px" }}>
                  <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="m9 9 5 12 1.8-5.2L21 14Z"/><path d="M7.2 2.2 8 5.1"/><path d="M5.1 8 2.2 7.2"/><path d="M14 4.1 12 6"/><path d="m6 12-1.9 2"/></svg>
                  Click for details
                </p>
              </div>
            )}
